...
<div class="fixed inset-x-0 bottom-0 max-w-[640px] z-50 bg-white shadow-sm mx-auto">
            <div class="flex items-center justify-between px-8 py-4">
                ...
                @endif
                <p 
                    class="{{ Route::current()->getName() == 'index' ? 'text-[#FF801A]' : 'text-[#606060]' }} font-[400] text-[12px]">Home</p>
                </a>
                ...
                <a href="{{ route('product.find', $store->username) }}" class="flex flex-col items-center gap-2">
                    ...
                    @endif
            <p 
                class="{{ Route::current()->getName() == 'product.find' ? 'text-[#FF801A]' : 'text-[#606060]' }} font-[400] text-[12px]">Find</p>
                </a>
