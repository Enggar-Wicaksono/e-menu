...
<div id="TopNavAbsolute"
    ...
    <a href="{{ route('index', $store->username)}}"
        ...
        <img src="{{asset('assets/images/icons/Thumbs Up.svg')}}" class="w-8 h-8" alt="icon">
    </a>
...
<div id="Image" class="relative w-full overflow-x-hidden -mb-[38px]">
    ...
    <div class="absolute bottom-20 right-5 flex items-center gap-1  bg-white/10 px-[8px] py-[4px] rounded-full">
        <img src="{{   asset('gambar/ic_star.png') }}" alt="rating" class="w-4 h-4">
                ...
                <div class="swiper-slide !w-fit">
                    <div
                        ...
                        <div class="flex items-center justify-between gap-3">
                            <h3 class="text-[#353535] font-[500] text-[14px]"></h3>

                            <div class="flex items-center gap-1">
                                <img src="{{ asset('gambar/ic_star.png') }}g" alt="rating" class="w-4 h-4">
                                <img src="{{ asset('gambar/ic_star.png') }}g" alt="rating" class="w-4 h-4">
                                <img src="{{ asset('gambar/ic_star.png') }}g" alt="rating" class="w-4 h-4">
                                <img src="{{ asset('gambar/ic_star.png') }}g" alt="rating" class="w-4 h-4">
                                <img src="{{ asset('gambar/ic_star.png') }}g" alt="rating" class="w-4 h-4">
