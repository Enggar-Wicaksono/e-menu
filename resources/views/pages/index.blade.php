...
@section('content')
<div id="Background"
    style="background: linear-gradient(90deg,#4CAF50 0%,#2E7D32 100%)"
    class="absolute top-0 w-full h-[170px] rounded-b-[45px]">
</div>
...
<div id="TopNav" class="relative flex flex-col px-5 mt-[20px] h-[170px]">
    ...
    <div class="absolute bottom-0 left-0 right-0 w-full gap-2 px-5">
        <label
            ...
            <img src="{{ asset('assets/images/icons/Search.svg') }}" class="w-8 h-8 flex shrink-0" alt="icon">
            ...
            <div
                ...
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <div class="flex items-center justify-between ">
                        ...
                        <button type="button"
                            class="flex items-center justify-center w-[24px] h-[24px] rounded-full bg-transparent"
                            data-id="{{$product->price}}" onclick="addToCart(this.dataset.id)">
                            <img src="{{ asset('assets/images/icons/ic_plus.svg') }}" class="w-full h-full" alt="icon">
                        </button>
                    </div>
                </div>
