                        ...
                        <div class="flex flex-col gap-4 mt-[10px]">
                            <div
                                ...
                                <div class="w-[128px] h-[88px]">
                                    <img src="{{ asset('storage/' . $transactionDetails->product->image) }}" class="w-full object-cover rounded-[8px]"
                                        alt="icon">
                                </div>
                                <div class="flex flex-col gap-1 w-full">
                                    <p class="text-[#F3AF00] font-[400] text-[12px]">
                                        {{ $transactionDetails->product->productCategory->name }}
                                    </p>
                                    ...
                                    <div class="flex items-center justify-between ">
                                        <p class="text-[#FF001A] font-[600] text-[14px]">
                                            Rp {{ number_format($transactionDetails->product->price)}}
                                        </p>
                                    </div>
                                </div>
                                <span id="qty">x{{ $transactionDetails->quantity  }}</span>
                            </div>
                        </div>
                        @endforeach
